...
async function myedit(id){
    ...
    let res = await data.json()
    let frm = `<br>
    <input type="text" value=${res.id} id="id1" readonly /> <br>
    <input type="text" value=${res.name} id="name1" /> <br>
    <input type="text" value=${res.city} id="city1" /> <br>
    <input type="text" value=${res.contact} id="contact1" /> <br>
    <input type="text" value=${res.email} id="email1" /> <br>
    <input type="text" value=${res.age} id="age1" /> <br>
    <button onclick="finalupdate('${res.id}')"> Final Update </button>
    `
